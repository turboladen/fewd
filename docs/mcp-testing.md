...
- Some recipes / people / meals exist in the DB so list-shaped tools return data. The sample family the server seeds into an empty `data/fewd.db` under `just dev` gives you a working baseline.
